...
The model used was a Proximal Policy Optimization The recorder was implemented as a part of the environment, which is a possibility in RL and not BC, so this was incredibly convenient to see the immediate results of an iteration of training. This strategy will be further utilized in successive tasks. 
