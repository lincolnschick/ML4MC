...
from backend.scripts import MineToSurfaceScript, CollectDiamondsScript, GatherStoneScript, CraftPickaxeScript, CraftSwordScript, PlaceTorchScript, HouseScript
