...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(9, 9, 1221, 591))
        ...
        self.goalSelectGroupbox.setGeometry(QtCore.QRect(10, 150, 381, 241))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 361, 211))
        ...
        self.resetEnvironmentButton.setGeometry(QtCore.QRect(10, 530, 381, 51))
        font = QtGui.QFont()
        ...
        self.agentButton.setGeometry(QtCore.QRect(10, 470, 381, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 400, 381, 61))
        ...
        self.interactorCheckbox.setGeometry(QtCore.QRect(230, 30, 141, 20))
        self.interactorCheckbox.setChecked(False)
        self.interactorCheckbox.setObjectName("interactorCheckbox")
        self.progressBar = QtWidgets.QProgressBar(parent=self.goalInfoGroupBox)
        self.progressBar.setGeometry(QtCore.QRect(7, 110, 381, 21))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(20, 40, 371, 154))
        ...
        self.experienceIcon = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.experienceIcon.setMaximumSize(QtCore.QSize(50, 50))
        self.experienceIcon.setText("")
        self.experienceIcon.setPixmap(QtGui.QPixmap("frontend/Assets/Experience_Orb.png"))
        self.experienceIcon.setScaledContents(True)
        self.experienceIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.experienceIcon.setObjectName("experienceIcon")
        self.horizontalLayout_6.addWidget(self.experienceIcon)
        self.experienceLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.experienceLabel.setMaximumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.experienceLabel.setFont(font)
        self.experienceLabel.setObjectName("experienceLabel")
        self.horizontalLayout_6.addWidget(self.experienceLabel)
        ...
        self.inventoryGroupBox.setGeometry(QtCore.QRect(10, 200, 381, 381))
        ...
        self.inventoryTable.setGeometry(QtCore.QRect(10, 30, 361, 341))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.actionGroupBox.setGeometry(QtCore.QRect(10, 30, 191, 121))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 171, 82))
        ...
        self.capturingGroupBox.setGeometry(QtCore.QRect(200, 30, 191, 121))
        ...
        self.horizontalLayoutWidget_7.setGeometry(QtCore.QRect(10, 30, 171, 82))
        ...
        self.scriptsGroupBox.setGeometry(QtCore.QRect(10, 160, 381, 421))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 140, 361, 241))
        self.groupBox_2.setObjectName("groupBox_2")
        self.gridLayoutWidget = QtWidgets.QWidget(parent=self.groupBox_2)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(9, 30, 341, 201))
        ...
        self.buildIcon = QtWidgets.QLabel(parent=self.gridLayoutWidget)
        self.buildIcon.setEnabled(True)
        self.buildIcon.setMaximumSize(QtCore.QSize(60, 60))
        self.buildIcon.setText("")
        self.buildIcon.setPixmap(QtGui.QPixmap("frontend/Assets/Oak_Planks.png"))
        self.buildIcon.setScaledContents(True)
        self.buildIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.buildIcon.setObjectName("buildIcon")
        self.horizontalLayout_17.addWidget(self.buildIcon)
        self.buildScriptButton = QtWidgets.QPushButton(parent=self.gridLayoutWidget)
        self.buildScriptButton.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.buildScriptButton.sizePolicy().hasHeightForWidth())
        self.buildScriptButton.setSizePolicy(sizePolicy)
        self.buildScriptButton.setMaximumSize(QtCore.QSize(75, 16777215))
        self.buildScriptButton.setIconSize(QtCore.QSize(50, 50))
        self.buildScriptButton.setObjectName("buildScriptButton")
        self.horizontalLayout_17.addWidget(self.buildScriptButton)
        self.gridLayout.addLayout(self.horizontalLayout_17, 2, 0, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(parent=self.scriptsGroupBox)
        self.groupBox.setGeometry(QtCore.QRect(10, 30, 361, 101))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(9, 30, 341, 64))
        ...
        self.stopScriptButton.setGeometry(QtCore.QRect(10, 390, 361, 24))
...
"Enemies"))
        ...
        self.experienceLabel.setText(_translate("MainWindow", "N/A"))
        ...
        self.actionGroupBox.setTitle(_translate("MainWindow", "Agent Controls"))
...
"Torch"))
        self.buildScriptButton.setText(_translate("MainWindow", "Build\n"
"House"))
