...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.interactorCheckbox.setChecked(True)
        ...
        self.inventoryGroupBox.setGeometry(QtCore.QRect(10, 140, 171, 501))
        ...
        self.inventoryTable.setGeometry(QtCore.QRect(10, 30, 151, 461))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.stepsGroupBox.setGeometry(QtCore.QRect(190, 140, 171, 501))
        self.stepsGroupBox.setObjectName("stepsGroupBox")
        self.stepsTable = QtWidgets.QTableWidget(parent=self.stepsGroupBox)
        self.stepsTable.setGeometry(QtCore.QRect(10, 30, 151, 461))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayoutWidget_6.setGeometry(QtCore.QRect(10, 30, 331, 321))
        self.horizontalLayoutWidget_6.setObjectName("horizontalLayoutWidget_6")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_6)
        self.horizontalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.groupBox = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget_6)
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget = QtWidgets.QWidget(parent=self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 146, 291))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.diamondScriptRadio = QtWidgets.QRadioButton(parent=self.layoutWidget)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Assets/diamond.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.diamondScriptRadio.setIcon(icon4)
        self.diamondScriptRadio.setIconSize(QtCore.QSize(50, 50))
        self.diamondScriptRadio.setObjectName("diamondScriptRadio")
        self.verticalLayout_4.addWidget(self.diamondScriptRadio)
        self.stoneScriptRadio = QtWidgets.QRadioButton(parent=self.layoutWidget)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Assets/cobble.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.stoneScriptRadio.setIcon(icon5)
        self.stoneScriptRadio.setIconSize(QtCore.QSize(50, 50))
        self.stoneScriptRadio.setObjectName("stoneScriptRadio")
        self.verticalLayout_4.addWidget(self.stoneScriptRadio)
        self.script3Radio = QtWidgets.QRadioButton(parent=self.layoutWidget)
        self.script3Radio.setEnabled(False)
        self.script3Radio.setIcon(icon3)
        self.script3Radio.setIconSize(QtCore.QSize(50, 50))
        self.script3Radio.setObjectName("script3Radio")
        self.verticalLayout_4.addWidget(self.script3Radio)
        self.stopScriptButton = QtWidgets.QPushButton(parent=self.layoutWidget)
        self.stopScriptButton.setEnabled(False)
        self.stopScriptButton.setObjectName("stopScriptButton")
        self.verticalLayout_4.addWidget(self.stopScriptButton)
        self.horizontalLayout_6.addWidget(self.groupBox)
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget_6)
        self.groupBox_2.setObjectName("groupBox_2")
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.groupBox_2)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 20, 141, 291))
        ...
        self.surfaceButton = QtWidgets.QPushButton(parent=self.layoutWidget1)
        self.surfaceButton.setIconSize(QtCore.QSize(50, 50))
        self.surfaceButton.setObjectName("surfaceButton")
        self.horizontalLayout_10.addWidget(self.surfaceButton)
        ...
        self.depthButton = QtWidgets.QPushButton(parent=self.layoutWidget1)
        self.depthButton.setIconSize(QtCore.QSize(50, 50))
        self.depthButton.setObjectName("depthButton")
        self.horizontalLayout_11.addWidget(self.depthButton)
        self.verticalLayout_5.addLayout(self.horizontalLayout_11)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.script3Img = QtWidgets.QLabel(parent=self.layoutWidget1)
        self.script3Img.setEnabled(False)
        self.script3Img.setMaximumSize(QtCore.QSize(50, 50))
        self.script3Img.setText("")
        self.script3Img.setPixmap(QtGui.QPixmap("Assets/torch.png"))
        self.script3Img.setScaledContents(True)
        self.script3Img.setObjectName("script3Img")
        self.horizontalLayout_12.addWidget(self.script3Img)
        self.script3Button = QtWidgets.QPushButton(parent=self.layoutWidget1)
        ...
        self.horizontalLayout_12.addWidget(self.script3Button)
...
"Enemies"))
        ...
        self.diamondScriptRadio.setText(_translate("MainWindow", "Mine\n"
"Diamond"))
        self.stoneScriptRadio.setText(_translate("MainWindow", "Gather\n"
"Stone"))
        self.script3Radio.setText(_translate("MainWindow", "Placeholder\n"
"Text"))
        ...
        self.surfaceButton.setText(_translate("MainWindow", "Mine to\n"
"Surface"))
        self.depthButton.setText(_translate("MainWindow", "Dig to\n"
"Depth"))
